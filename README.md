...
> Auto simple symmetric text encryption (fernet)

[![PyPI version](https://badge.fury.io/py/auto-encrypt-text.svg)](https://pypi.org/project/auto-encrypt-text/)
...
```bash
pip install auto-encrypt-text
```

## Quick Start

```python
from auto_encrypt_text import text
...
from auto_encrypt_text import batch
